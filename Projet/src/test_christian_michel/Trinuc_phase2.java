//IDEM A PHASE 0 MAIS POUR LA PHASE 2
package test_christian_michel;
import java.text.DecimalFormat;
public class Trinuc_phase2 {

	public float[] freq;
	String[] tri_nuc;
	int[] compteur;
	public Trinuc_phase2(String test)
	{
		String substring=test.substring(2,test.length()-1);
                /*
                System.out.println("Phase 2__ :");
                System.out.println(substring);*/
                String[] result = phase2(substring);
                this.count_phase2(result);
                /*
                for(int i = 0;i<64;i++){
	...
	private String[] phase2 (String genome)
	{
	...
	private void count_phase2(String[] result)
	{
